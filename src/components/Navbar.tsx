...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full z-[990] flex items-center justify-between px-6 md:px-12 transition-all duration-300 bg-zinc-950/80 backdrop-blur-md ${
          isScrolled ? 'h-16 border-b border-white/5' : 'h-20'
        }`}
      >
        {/* Brand Logo */}
        <Link
